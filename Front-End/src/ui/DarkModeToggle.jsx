    ...
    >
      ...
      <div className="absolute inset-0 rounded-full overflow-hidden">
        ...
        >
          ...
          <ellipse cx="20" cy="11" rx="3" ry="1.5" fill="rgba(255,255,255,0.7)" />
          <ellipse cx="30" cy="20" rx="3" ry="1.5" fill="rgba(255,255,255,0.6)" />
        </svg>
      ...
      <div
        className={`absolute top-1 w-5 h-5  rounded-full shadow-sm transform transition-transform duration-300 ease-in-out ${
          isDark ? "-translate-x-1 bg-secondary-50" : "-translate-x-8 bg-yellow-300 "
        }`}
      ></div>
